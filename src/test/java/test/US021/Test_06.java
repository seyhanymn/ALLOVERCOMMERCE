...
public class Test_06 extends TestBaseRapor {
    ...
    public void test01() {
        ...
        fettahAlloverPage.customBox.click();
        wait.until(ExpectedConditions.visibilityOf(fettahAlloverPage.takvim));
        actions.sendKeys(Keys.PAGE_DOWN).perform();
        fettahAlloverPage.gunler.get(15).click();
        fettahAlloverPage.gunler.get(25).click();
        fettahAlloverPage.customBox.click();
        actions.sendKeys(Keys.PAGE_DOWN).perform();
