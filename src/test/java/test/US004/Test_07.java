...
public class Test_07 {
    ...
    public void test01() throws InterruptedException, IOException {
        ...
        // Clear cart ile butonuna basilir, acilan sayfada "Your cart is currently empty." mesaji dogrulanir

        ilkerAlloverPage.viewCarttaClearCart.click();

        Assert.assertTrue(ilkerAlloverPage.yourCartCurrentlyEmpty.isDisplayed());
