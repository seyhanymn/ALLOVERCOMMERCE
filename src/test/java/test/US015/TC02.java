...
public class TC02 extends TestBaseRapor {
    ...
    public void testTC01() throws InterruptedException, IOException {
        ...
        fezaAlloverPage.limitUsageToXItems.sendKeys("8");
        ReusableMethods.getScreenshotWebElement("limitUsageToXItems",fezaAlloverPage.usagelimitArea);
        extentTest.pass("Belirli ürünlere coupon limiti  girilebildiğini  dogrulandı");
    }
}
