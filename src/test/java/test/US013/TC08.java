...
public class TC08 extends TestBaseRapor {
    ...
    public void testTC008() {
        ...
        jse.executeScript("arguments[0].click();",fezaAlloverPage.showOnStore);
        Assert.assertTrue(fezaAlloverPage.showOnStore.isSelected());
        extentTest.pass("Show on store  butonunun tıklandığı  dogrulandı");
