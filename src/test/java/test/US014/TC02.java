...
public class TC02 extends TestBaseRapor {
    ...
    public void testTC02() throws InterruptedException, IOException {
        ...
        Assert.assertTrue(fezaAlloverPage.maximumSpendTextArea.isEnabled());
        fezaAlloverPage.maximumSpendTextArea.sendKeys("2500");
        ReusableMethods.getScreenshotWebElement("maximumSpendTextArea",fezaAlloverPage.excludeProductsNew);
        extentTest.pass("Maximum spend tutarı girildiği  dogrulandı");
