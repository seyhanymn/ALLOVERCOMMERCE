...
public class TC03 extends TestBaseRapor {
    ...
    public void testTC03() throws InterruptedException, IOException {
        ...
        Assert.assertTrue(fezaAlloverPage.individualUseOnly.isEnabled());
        fezaAlloverPage.individualUseOnly.click();
        ReusableMethods.getScreenshotWebElement("individualUseOnly",fezaAlloverPage.excludeProductsNew);
        extentTest.pass("Individual use only  tıklandığı  dogrulandı");
    }
}
