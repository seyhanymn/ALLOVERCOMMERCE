...
public class TC04 extends TestBaseRapor {
    ...
    public void testTC04() throws InterruptedException, IOException {
        ...
        fezaAlloverPage.excludeProducts.sendKeys("TAKIM");
        Thread.sleep(2000);
        actions.sendKeys(Keys.ENTER).perform();
        Thread.sleep(1000);
        ReusableMethods.getScreenshotWebElement("excludeProducts",fezaAlloverPage.excludeProductsNew);
        extentTest.pass("hariç tutmak için ürün seçilebildiği dogrulandı");
    }
}
